...
export default function CalculateButton({
  ...
  const calculateDamage = async () => {
    ...
    const damage = await PoGoAPI.getDamageAttack(attacker, defender, move, attackerStats, defenderStats, bonusAttacker, bonusDefender, raidMode, additionalBonus, shroomBonus);
